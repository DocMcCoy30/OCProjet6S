...
<main role="main">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                {% include icons/placeholder.svg width="100%" height="100%" background="#777" color="#777" text=" "
                title=" " %}
                <div class="container">
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                {% include icons/placeholder.svg width="140" height="140" background="#777" color="#777"
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                {% include icons/placeholder.svg width="500" height="500" background="#eee" color="#aaa"
